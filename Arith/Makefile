...
#
# Last updated: 3/22/2021 by Kenny Lin (klin04) and Janya Gambhir (jgambh01)
...
LDFLAGS = -g -L/comp/40/build/lib -L/usr/sup/cii40/lib64 -L/comp/40/build/lib 
...
40image: 40image.o compress40.o a2blocked.o uarray2b.o uarray2.o bitpack.o \
	    a2plain.o a2blocked.o convert40.o math40.o pack40.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
